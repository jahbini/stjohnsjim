# #-------- class start
renderer = class  the_great_aerial_tram_station extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_the_great_aerial_tram_station: =>
    T.div "#post-the-great-aerial-tram-station.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Great Aerial Tram Station"
          @bloviation()
        T.div ".article-footer.hide", =>
          T.a ".article-share-link", "data-url": "http://localhost:3030/stjohnsjim/st-johns-baltimore-wood/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
...
db[id="stjohnsjim/st-johns-baltimore-wood/the-great-aerial-tram-station"] =
  title: "The Great Aerial Tram Station"
  slug: "the-great-aerial-tram-station"
  category: "st-johns-baltimore-wood"
  site: "59781236d3cfff7cc5f92609"
