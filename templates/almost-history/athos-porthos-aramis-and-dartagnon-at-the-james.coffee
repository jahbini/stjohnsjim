...
class  athos_porthos_aramis_and_dartagnon_at_the_james extends stjohnsjimtemplate
  ...
  # 
  post_athos_porthos_aramis_and_dartagnon_at_the_james: =>
    T.div "#post-athos-porthos-aramis-and-dartagnon-at-the-james.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Athos, Porthos, Aramis and Dartagnon at the James"
          @bloviation()
...
# ------- db start
db = {} unless db
db[id="59782449d3cfff7cc5f92664"] =
  ...
  accepted: true
  index: false
  sourcePath: "stjohnsjim/contents/tarot/athos-porthos-aramis-and-dartagnon-at-the-james.md"
  headlines: []
  tags: []
  snippets: "{}"
  memberOf: [
