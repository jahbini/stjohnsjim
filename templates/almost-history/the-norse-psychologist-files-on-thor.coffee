...
"""
  ...
  # 
  post_the_norse_psychologist_files_on_thor: =>
    T.div "#post-the-norse-psychologist-files-on-thor.article.article-type-post", id: "post-the-norse-psychologist-files-on-thor", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Norse Psychologist Files on Thor"
          @bloviation()
