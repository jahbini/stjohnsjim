...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_the_great_bank_robbery()
  # 
  # section post_the_great_bank_robbery
  # 
  post_the_great_bank_robbery: =>
    T.div "#post-the-great-bank-robbery.article.article-type-post", id: "post-the-great-bank-robbery", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Great Bank Robbery"
          @bloviation()
