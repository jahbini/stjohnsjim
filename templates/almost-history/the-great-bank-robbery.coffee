# #-------- class start
renderer = class  the_great_bank_robbery extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_the_great_bank_robbery: =>
    T.div "#post-the-great-bank-robbery.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Great Bank Robbery"
          @bloviation()
