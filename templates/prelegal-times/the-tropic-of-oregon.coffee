# 
class the_tropic_of_oregon extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_the_tropic_of_oregon()
  # 
  # section post_the_tropic_of_oregon
  # 
  post_the_tropic_of_oregon: =>
    T.div "#post-the-tropic-of-oregon.article.article-type-post", id: "post-the-tropic-of-oregon", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Tropic of Oregon"
          @bloviation()
        T.div ".article-footer.hide", class: "article-footer hide", =>
          T.a ".article-share-link", class: "article-share-link", "data-url": "http://localhost:3030/stjohnsjim/prelegal-times/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.ul =>
        T.li =>
          T.p =>
            T.raw "One of my readers is an ex Shock Jock from Southern California.  He sings &quot;Paint it Black&quot; on Girl Scout road trips.  He favorably compared my writing to toilet paper: You can start on any sheet you want.  Thanks!  Ahhhh,"
            T.span ".FBname", class: "FBname", => T.raw "Friend"
            T.raw ", I’m a sucker for compliments."
        T.li =>
          T.p => T.raw "I sometimes miss Honolulu. (As Roger from Gunas Lp might say: &quot;Ya think?&quot;)  The weather, acceptance and aloha of the Islands are still vivid in my mind.  You can imagine my surprise when I found there is club that has a chain of resorts called the Tropic of Oregon."
