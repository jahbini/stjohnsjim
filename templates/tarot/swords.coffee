# #-------- class start
renderer = class  swords extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_swords: =>
    T.div "#post-swords.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Swords"
          @bloviation()
  ...
  # 
  king_of_swords: =>
    T.h2 "#king-of-swords", => T.raw "King of Swords"
  # 
  # section queen_of_swords
  # 
  queen_of_swords: =>
    T.h2 "#queen-of-swords", => T.raw "Queen of Swords"
  # 
  # section knight_of_swords
  # 
  knight_of_swords: =>
    T.h2 "#knight-of-swords", => T.raw "Knight of Swords"
  # 
  # section page_of_swords
  # 
  page_of_swords: =>
    T.h2 "#page-of-swords", => T.raw "Page of Swords"
  # 
  # section ten_of_swords
  # 
  ten_of_swords: =>
    T.h2 "#ten-of-swords", => T.raw "Ten of Swords"
  # 
  # section nine_of_swords
  # 
  nine_of_swords: =>
    T.h2 "#nine-of-swords", => T.raw "Nine of Swords"
  # 
  # section eight_of_swords
  # 
  eight_of_swords: =>
    T.h2 "#eight-of-swords", => T.raw "Eight of Swords"
  # 
  # section seven_of_swords
  # 
  seven_of_swords: =>
    T.h2 "#seven-of-swords", => T.raw "Seven of Swords"
  # 
  # section six_of_swords
  # 
  six_of_swords: =>
    T.h2 "#six-of-swords", => T.raw "Six of Swords"
  # 
  # section five_of_swords
  # 
  five_of_swords: =>
    T.h2 "#five-of-swords", => T.raw "Five of Swords"
  # 
  # section four_of_swords
  # 
  four_of_swords: =>
    T.h2 "#four-of-swords", => T.raw "Four of Swords"
  # 
  # section three_of_swords
  # 
  three_of_swords: =>
    T.h2 "#three-of-swords", => T.raw "Three of Swords"
  # 
  # section two_of_swords
  # 
  two_of_swords: =>
    T.h2 "#two-of-swords", => T.raw "Two of Swords"
  # 
  # section ace_of_swords
  # 
  ace_of_swords: =>
    T.h2 "#ace-of-swords", => T.raw "Ace of Swords"
  # 
  # section header
  # 
  # 
...
db[id="59782449d3cfff7cc5f92643"] =
  ...
  created: "2011-11-13T12:24:20.000Z"
  lastEdited: "2011-11-13T13:10:34.000Z"
