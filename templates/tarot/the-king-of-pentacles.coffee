...
"""
  ...
  # 
  post_the_king_of_pentacles: =>
    T.div "#post-the-king-of-pentacles.article.article-type-post", id: "post-the-king-of-pentacles", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The King of Pentacles"
          @bloviation()
