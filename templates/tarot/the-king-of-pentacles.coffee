# #-------- class start
renderer = class  the_king_of_pentacles extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  mainUnused: =>
    T.div "#main", =>
      @post_the_king_of_pentacles()
  # 
  # section post_the_king_of_pentacles
  # 
  post_the_king_of_pentacles: =>
    T.div "#post-the-king-of-pentacles.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The King of Pentacles"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "A king of pentacles is an entrepreneur, a small business owner. Anyone that has mastered the several ways that earn money and may choose to be employer, tradesman, artisan, merchant, industrialist."
  # 
  # section header
  # 
  # 
...
db[id="stjohnsjim/tarot/the-king-of-pentacles"] =
  title: "The King of Pentacles"
  slug: "the-king-of-pentacles"
  category: "tarot"
  site: "59781236d3cfff7cc5f92609"
