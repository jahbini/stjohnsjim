# #-------- class start
renderer = class  maslow_and_celarien_tarot extends siteTemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_maslow_and_celarien_tarot: =>
    T.div "#post-maslow-and-celarien-tarot.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Maslow and Celarien Tarot"
          @bloviation()
