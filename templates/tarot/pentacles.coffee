# #-------- class start
renderer = class  pentacles extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_pentacles: =>
    T.div "#post-pentacles.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Pentacles"
          @bloviation()
  ...
  # 
  king_of_pentacles: =>
    T.h2 "#king-of-pentacles", => T.raw "King of Pentacles"
  # 
  # section queen_of_pentacles
  # 
  queen_of_pentacles: =>
    T.h2 "#queen-of-pentacles", => T.raw "Queen of Pentacles"
  # 
  # section knight_of_pentacles
  # 
  knight_of_pentacles: =>
    T.h2 "#knight-of-pentacles", => T.raw "Knight of Pentacles"
  # 
  # section page_of_pentacles
  # 
  page_of_pentacles: =>
    T.h2 "#page-of-pentacles", => T.raw "Page of Pentacles"
  # 
  # section ten_of_pentacles
  # 
  ten_of_pentacles: =>
    T.h2 "#ten-of-pentacles", => T.raw "Ten of Pentacles"
  # 
  # section nine_of_pentacles
  # 
  nine_of_pentacles: =>
    T.h2 "#nine-of-pentacles", => T.raw "Nine of Pentacles"
  # 
  # section eight_of_pentacles
  # 
  eight_of_pentacles: =>
    T.h2 "#eight-of-pentacles", => T.raw "Eight of Pentacles"
  # 
  # section seven_of_pentacles
  # 
  seven_of_pentacles: =>
    T.h2 "#seven-of-pentacles", => T.raw "Seven of Pentacles"
  # 
  # section six_of_pentacles
  # 
  six_of_pentacles: =>
    T.h2 "#six-of-pentacles", => T.raw "Six of Pentacles"
  # 
  # section five_of_pentacles
  # 
  five_of_pentacles: =>
    T.h2 "#five-of-pentacles", => T.raw "Five of Pentacles"
  # 
  # section four_of_pentacles
  # 
  four_of_pentacles: =>
    T.h2 "#four-of-pentacles", => T.raw "Four of Pentacles"
  # 
  # section three_of_pentacles
  # 
  three_of_pentacles: =>
    T.h2 "#three-of-pentacles", => T.raw "Three of Pentacles"
  # 
  # section two_of_pentacles
  # 
  two_of_pentacles: =>
    T.h2 "#two-of-pentacles", => T.raw "Two of Pentacles"
  # 
  # section ace_of_pentacles
  # 
  ace_of_pentacles: =>
    T.h2 "#ace-of-pentacles", => T.raw "Ace of Pentacles"
  # 
  # section pentacles_dilligent_earthy_prosperity_bound_
  # 
  pentacles_dilligent_earthy_prosperity_bound_: =>
    T.h1 "#pentacles-dilligent-earthy-prosperity-bound-", => T.raw "Pentacles – Dilligent. Earthy. Prosperity bound."
  # 
  # section header
  # 
  # 
