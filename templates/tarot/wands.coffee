# #-------- class start
renderer = class  wands extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_wands: =>
    T.div "#post-wands.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Wands"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p => T.raw "subsubsection{Two of Wands}"
  ...
  # 
  # section king_of_wands
  # 
  king_of_wands: =>
    T.h2 "#king-of-wands", => T.raw "King of Swords"
  # 
  # section queen_of_wands
  # 
  queen_of_wands: =>
    T.h2 "#queen-of-wands", => T.raw "Queen of Swords"
  # 
  # section knight_of_wands
  # 
  knight_of_wands: =>
    T.h2 "#knight-of-wands", => T.raw "Knight of Swords"
  # 
  # section page_of_wands
  # 
  page_of_wands: =>
    T.h2 "#page-of-wands", => T.raw "Page of Swords"
  # 
  # section ten_of_wands
  # 
  ten_of_wands: =>
    T.h2 "#ten-of-wands", => T.raw "Ten of Swords"
  # 
  # section nine_of_wands
  # 
  nine_of_wands: =>
    T.h2 "#nine-of-wands", => T.raw "Nine of Swords"
  # 
  # section eight_of_wands
  # 
  eight_of_wands: =>
    T.h2 "#eight-of-wands", => T.raw "Eight of Swords"
  # 
  # section seven_of_wands
  # 
  seven_of_wands: =>
    T.h2 "#seven-of-wands", => T.raw "Seven of Swords"
  # 
  # section six_of_wands
  # 
  six_of_wands: =>
    T.h2 "#six-of-wands", => T.raw "Six of Swords"
  # 
  # section five_of_wands
  # 
  five_of_wands: =>
    T.h2 "#five-of-wands", => T.raw "Five of Swords"
  # 
  # section four_of_wands
  # 
  four_of_wands: =>
    T.h2 "#four-of-wands", => T.raw "Four of Swords"
  # 
  # section three_of_wands
  # 
  three_of_wands: =>
    T.h2 "#three-of-wands", => T.raw "Three of Swords"
  # 
  # section two_of_wands
  # 
  two_of_wands: =>
    T.h2 "#two-of-wands", => T.raw "Two of Swords"
  # 
  # section ace_of_wands
  # 
  ace_of_wands: =>
    T.h2 "#ace-of-wands", => T.raw "Ace of Swords"
  # 
  # section header
  # 
  # 
...
db[id="5978244ad3cfff7cc5f92693"] =
  title: "Wands"
  slug: "wands"
  category: "tarot"
  site: "stjohnsjim"
