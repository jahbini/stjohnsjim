# 
class new_look extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  # 
  post_new_look: =>
    T.div "#post-new-look.article.article-type-post", id: "post-new-look", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "New Look!"
          @bloviation()
        T.div ".article-footer.hide", class: "article-footer hide", =>
          T.a ".article-share-link", class: "article-share-link", "data-url": "http://localhost:3030/stjohnsjim/announcement/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.h2 => T.raw "wowzers!"
      T.p ".circle.border", class: "circle border", =>
        T.raw """
I'm writing this new article without a wysiwig editor: I'm going primitive!
Everything is now in
"""
        T.span ".px1.fa.fa-coffee", class: "px1 fa fa-coffee", => T.raw "Coffeescript."
      T.p => T.raw """
...
"""
      T.aside ".border.rounded.bg-silver.h4.no-column-break", class: "border rounded bg-silver h4 no-column-break", =>
        T.pre ".h6", class: "h6", => T.raw """
T.p &quot;.circle.border&quot;, -&gt;
   T.raw &quot;&quot;&quot;
I'm writing this new article without a wysiwig editor: I'm going primitive!
Everything is now in
...
"""
      ...
      T.div ".siteInvitation", class: "siteInvitation"
      T.p => T.raw """
