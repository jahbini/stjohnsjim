...
"""
  ...
  # 
  post_catchy_slogan_sunday: =>
    T.div "#post-catchy-slogan-sunday.article.article-type-post", id: "post-catchy-slogan-sunday", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Catchy Slogan Sunday"
          @bloviation()
        T.div ".article-footer.hide", class: "article-footer hide", =>
          T.a ".article-share-link", class: "article-share-link", "data-url": "http://localhost:3030/stjohnsjim/st-johns/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
