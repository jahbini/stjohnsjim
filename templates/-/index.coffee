...
"""
  ...
  # 
  post_index: =>
    T.div "#post-index.article.article-type-post", id: "post-index", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Grand Visions from the 'Puter of St. John's Jim"
          @bloviation()
        T.div ".article-footer.hide", class: "article-footer hide", =>
          T.a ".article-share-link", class: "article-share-link", "data-url": "http://localhost:3030/stjohnsjim/-/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
...
"""
  ...
  # 
  hail_cascadia_: =>
    T.h2 "#hail-cascadia-", id: "hail-cascadia-", => T.raw "Hail! Cascadia!"
  # 
  # section the_movement_is_on_us_
  # 
  the_movement_is_on_us_: =>
    T.h3 "#the-movement-is-on-us-", id: "the-movement-is-on-us-", => T.raw "the movement is on us!"
  # 
  # section cascadia_free_forever_
  # 
  cascadia_free_forever_: =>
    T.h2 "#cascadia-free-forever-", id: "cascadia-free-forever-", => T.raw "Cascadia Free Forever!"
  # 
  # section announcement_
  # 
  announcement_: =>
    T.h1 "#announcement-", id: "announcement-", => T.raw "Announcement!"
  # 
  # section header
  # 
  header: =>
