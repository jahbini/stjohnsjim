# #-------- class start
class  random_quotes extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  main: =>
    T.div "#main", =>
      @post_random_quotes()
  # 
  # section post_random_quotes
  # 
  post_random_quotes: =>
    T.div "#post-random-quotes.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Random quotes"
          @bloviation()
...
#-------- class end
page = new random_quotes
rendered =  T.render page.html
# ------- db start
db = {} unless db


db[id="59782449d3cfff7cc5f9266b"] =
  title: "Random quotes"
  slug: "random-quotes"
  category: "backstory"
  ...
  created: "2011-10-03T11:38:43.000Z"
  lastEdited: "2011-10-03T11:38:43.000Z"
  ...
  debug: ""
  id: "59782449d3cfff7cc5f9266b"
  name: "Random quotes"
#



db[id="stjohnsjim/backstory/random-quotes"] =
  title: "Random quotes"
  slug: "random-quotes"
  category: "backstory"
  site: "59781236d3cfff7cc5f92609"
