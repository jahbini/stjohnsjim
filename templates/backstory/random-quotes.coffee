...
"""
  ...
  # 
  post_random_quotes: =>
    T.div "#post-random-quotes.article.article-type-post", id: "post-random-quotes", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Random quotes"
          @bloviation()
