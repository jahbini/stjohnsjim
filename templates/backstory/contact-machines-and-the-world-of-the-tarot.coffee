...
"""
  ...
  # 
  post_contact_machines_and_the_world_of_the_tarot: =>
    T.div "#post-contact-machines-and-the-world-of-the-tarot.article.article-type-post", id: "post-contact-machines-and-the-world-of-the-tarot", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Contact Machines and the World of the Tarot"
          @bloviation()
