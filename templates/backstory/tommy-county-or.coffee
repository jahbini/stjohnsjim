# 
class tommy_county_or extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_tommy_county_or()
  # 
  # section post_tommy_county_or
  # 
  post_tommy_county_or: =>
    T.div "#post-tommy-county-or.article.article-type-post", id: "post-tommy-county-or", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Tommy County, OR"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p => T.raw "&gt; Notable citizens: The Three Wise Men at Mayor Tommy’s house at {{{3gunas:3 Gunas Lp}}}."
      T.p => T.raw "&gt; &gt; Religious Affiliation: The Church of Who Gives a Fuck 80% / Transcendent Ignorance 20%"
  # 
  # section header
  # 
  header: =>
