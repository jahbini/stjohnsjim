...
"""
  ...
  # 
  post_dizzy_the_fools_dog: =>
    T.div "#post-dizzy-the-fools-dog.article.article-type-post", id: "post-dizzy-the-fools-dog", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Dizzy -- The Fool's Dog"
          @bloviation()
