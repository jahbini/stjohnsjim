# #-------- class start
class  anna_played_piana extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  main: =>
    T.div "#main", =>
      @post_anna_played_piana()
  # 
  # section post_anna_played_piana
  # 
  post_anna_played_piana: =>
    T.div "#post-anna-played-piana.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Anna Played Piana"
          @bloviation()
        T.div ".article-footer.hide", =>
          T.a ".article-share-link", "data-url": "http://localhost:3030/stjohnsjim/california/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p =>
        T.raw "&quot;"
        T.em => T.raw "My Anna played Piana in a bar in Singapore, till one day a sailor man from turkey-stan came knocking at the door."
        T.raw "&quot; –"
        T.strong => T.raw "Walt Kelly"
      T.p => T.raw "So Anna was immortalized many years ago by Pogo Possum’s creator, but few know of the story of the real Anna after she left Singapore in 1964."
      ...
      T.p => T.raw "Liberace returned secretly many times to Singapore as he turned Anna’s piano act into a major review of the life of Marilyn Monroe. He would later produce the show in Las Vegas."
      ...
      T.p =>
        T.raw "As I departed, I asked Anna about the real Monroe’s affair with JFK. She giggled, and said &quot;the other brothers found my act"
        T.em => T.raw "stimulating"
        T.raw ".&quot; She would not elaborate, but I’m sure there is another story there."
      T.p => T.raw "PS: And what about the Elton John connection??"
      T.p =>
        T.em => T.raw "Author’s Note: even though this mainly is in Las Vegas, We consider that Far-Eastern LA and hence part of California"
  # 
  # section header
  # 
  # 
