# #-------- class start
renderer = class  coala_harbor_cat extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_coala_harbor_cat: =>
    T.div "#post-coala-harbor-cat.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Coala: Harbor Cat"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.div()
        T.raw "Southwick: Take a back seat, buddy. Let me work here.   – Coala, Coala, make yourself known-la."
      ...
      T.p =>
        T.div()
        T.raw "Coala: Hey, don’t interrupt me. I’m just getting to the scary part."
      ...
      T.p =>
        T.div()
        T.raw "Coala: Yeah, They called it a fishnet, but it wasn’t made of fish. Stupid name. They should call it snake nest, if you ask me. I hate snakes. Do you know how humiliating it is to be saved by skinny snakes?  And I’m all WET?! That’s really insulting. That’s the kind of magic that freaks me out.  Jeez, humans."
      ...
      T.p =>
        T.div()
        T.raw "Coala: Hey! What are you? An akashic cosmic welcher? You said I get fish offal!  Watch out or I’ll pee on your underwear."
