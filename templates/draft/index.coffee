    ...
    T.div "#post-index.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Things not ready for human consumption"
          @bloviation()
        T.div ".article-footer.hide", =>
          T.a ".article-share-link", "data-url": "http://localhost:3030/stjohnsjim/draft/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
...
# ------- db start
db = {} unless db
db[id="59782449d3cfff7cc5f92660"] =
  ...
  accepted: false
  index: true
  sourcePath: "stjohnsjim/contents/draft/index.md"
  headlines: [
