...
"""
  ...
  # 
  post_scene_3_nobrow_and_throntle: =>
    T.div "#post-scene-3-nobrow-and-throntle.article.article-type-post", id: "post-scene-3-nobrow-and-throntle", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Scene 3, Nobrow and Throntle"
          @bloviation()
