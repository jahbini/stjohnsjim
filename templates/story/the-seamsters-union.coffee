# #-------- class start
renderer = class  the_seamsters_union extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_the_seamsters_union: =>
    T.div "#post-the-seamsters-union.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Seamster's Union"
          @bloviation()
