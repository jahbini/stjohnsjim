...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_the_seamsters_union()
  # 
  # section post_the_seamsters_union
  # 
  post_the_seamsters_union: =>
    T.div "#post-the-seamsters-union.article.article-type-post", id: "post-the-seamsters-union", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Seamster's Union"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p =>
        T.raw "Seamstress.&nbsp; A woman who sews.&nbsp; Not a man who sews.&nbsp; But try as I might, there is no unisex term that I know of.&nbsp; The word would be seamster.&nbsp; But seamster isn’t a word.&nbsp; You have never heard it in use. ipso facto, Tempus Fugit, Notary Sojak,"
        T.em => T.raw "IT AINT A WORD"
        T.raw "!"
      T.p => T.raw "But here in the Politically Correct, Stake of Oregon Through Your Chest, Hope to Make You Cry, Pacific North West&nbsp; ( God’s own country, He whizzes here daily) you had better be especially gender neutral!"
      ...
      T.p => T.raw "Gender language is especially sensitive in Portland.&nbsp; We have a wide variety of folks of all persuasions, accomplishments, preferences and passions."
      ...
      T.p => T.raw "So let’s get on board with our new word:&nbsp; Seamster.&nbsp; A person who is a laborer in the garment industry on sewing equipment."
      T.p => T.raw "You better get with it, and be very careful.&nbsp; The Seamster’s Union is a very powerful agency here in Portland.&nbsp; And here in St. John’s? Very Powerful.&nbsp; You’ve been warned."
  # 
  # section header
  # 
  header: =>
