# #-------- class start
renderer = class  dentists_electrons_and_kings extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_dentists_electrons_and_kings: =>
    T.div "#post-dentists-electrons-and-kings.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Dentists, Electrons and Kings"
          @bloviation()
