...
"""
  ...
  # 
  post_whats_across_the_bridge_1: =>
    T.div "#post-whats-across-the-bridge-1.article.article-type-post", id: "post-whats-across-the-bridge-1", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "What's Across the Bridge -- #1"
          @bloviation()
