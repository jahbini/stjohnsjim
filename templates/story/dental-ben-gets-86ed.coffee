...
"""
  ...
  # 
  post_dental_ben_gets_86ed: =>
    T.div "#post-dental-ben-gets-86ed.article.article-type-post", id: "post-dental-ben-gets-86ed", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Dental Ben gets 86ed"
          @bloviation()
