...
"""
  ...
  # 
  post_calliope_contemplates_throntle_intimidates: =>
    T.div "#post-calliope-contemplates-throntle-intimidates.article.article-type-post", id: "post-calliope-contemplates-throntle-intimidates", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Calliope Contemplates, Throntle Intimidates"
          @bloviation()
