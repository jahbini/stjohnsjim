# #-------- class start
renderer = class  shanghai_squirrels_by_the_score extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_shanghai_squirrels_by_the_score: =>
    T.div "#post-shanghai-squirrels-by-the-score.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Shanghai Squirrels by the Score"
          @bloviation()
...
db[id="59782449d3cfff7cc5f9262d"] =
