...
"""
  ...
  # 
  post_julian_assange_vs_happy_birthday: =>
    T.div "#post-julian-assange-vs-happy-birthday.article.article-type-post", id: "post-julian-assange-vs-happy-birthday", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Julian Assange Vs Happy Birthday"
          @bloviation()
