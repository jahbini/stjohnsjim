# #-------- class start
renderer = class  neither_forest_nor_trees_and_sigh_mentors extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_neither_forest_nor_trees_and_sigh_mentors: =>
    T.div "#post-neither-forest-nor-trees-and-sigh-mentors.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Neither Forest Nor Trees and, sigh,  Mentors"
          @bloviation()
