# #-------- class start
renderer = class  angels_and_creatures_of_the_night extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_angels_and_creatures_of_the_night: =>
    T.div "#post-angels-and-creatures-of-the-night.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Angels and Creatures of the Night"
          @bloviation()
