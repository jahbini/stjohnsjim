# #-------- class start
renderer = class  mothers_day_and_the_parade_of_the_johns extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_mothers_day_and_the_parade_of_the_johns: =>
    T.div "#post-mothers-day-and-the-parade-of-the-johns.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Mother's Day and the Parade of the Johns"
          @bloviation()
