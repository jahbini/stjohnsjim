# #-------- class start
renderer = class  big_rocks_burgers_and_birds extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_big_rocks_burgers_and_birds: =>
    T.div "#post-big-rocks-burgers-and-birds.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Big Rocks, Burgers and Birds"
          @bloviation()
  ...
  # 
  _mdash_nbsp_for_immediate_release: =>
    T.h4 "#-mdash-nbsp-for-immediate-release", => T.raw "&mdash;&nbsp;For immediate release"
  # 
  # section from_the_famed_gutbuster_institute_of_the_st_john_rsquo_s_infirmary
  # 
  from_the_famed_gutbuster_institute_of_the_st_john_rsquo_s_infirmary: =>
    T.h3 "#from-the-famed-gutbuster-institute-of-the-st-john-rsquo-s-infirmary", => T.raw "From the Famed GutBuster Institute of The St. John&rsquo;s Infirmary"
  # 
  # section header
  # 
  # 
...
db[id="59782449d3cfff7cc5f92682"] =
  ...
  created: "2010-12-23T16:14:14.000Z"
  lastEdited: "2010-12-23T17:10:49.000Z"
...
db[id="stjohnsjim/story/big-rocks-burgers-and-birds"] =
  title: "Big Rocks, Burgers and Birds"
  slug: "big-rocks-burgers-and-birds"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
