...
"""
  ...
  # 
  post_the_monk_in_the_kingdom_of_prosperity: =>
    T.div "#post-the-monk-in-the-kingdom-of-prosperity.article.article-type-post", id: "post-the-monk-in-the-kingdom-of-prosperity", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Monk in the Kingdom of Prosperity"
          @bloviation()
