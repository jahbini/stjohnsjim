...
renderer = class  from_the_st_johns_infirmary_the_bouncer extends siteTemplate
  ...
  # 
  post_from_the_st_johns_infirmary_the_bouncer: =>
    T.div "#post-from-the-st-johns-infirmary-the-bouncer.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "From the St. John's Infirmary -- The Bouncer"
          @bloviation()
