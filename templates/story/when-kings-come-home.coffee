# #-------- class start
renderer = class  when_kings_come_home extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_when_kings_come_home: =>
    T.div "#post-when-kings-come-home.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "When Kings Come Home"
          @bloviation()
...
db[id="5978244ad3cfff7cc5f926b8"] =
  ...
  created: "2010-12-10T16:50:07.000Z"
  lastEdited: "2010-12-10T17:54:37.000Z"
  ...
  debug: ""
  id: "5978244ad3cfff7cc5f926b8"
  name: "When Kings Come Home"
#



db[id="stjohnsjim/story/when-kings-come-home"] =
  title: "When Kings Come Home"
  slug: "when-kings-come-home"
  category: "story"
  site: "stjohnsjim"
