# #-------- class start
renderer = class  kings_of_pentacles extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_kings_of_pentacles: =>
    T.div "#post-kings-of-pentacles.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Kings of Pentacles"
          @bloviation()
...
db[id="59782449d3cfff7cc5f92687"] =
  ...
  created: "2010-11-04T16:52:32.000Z"
  lastEdited: "2010-11-04T18:46:00.000Z"
...
db[id="stjohnsjim/story/kings-of-pentacles"] =
  title: "Kings of Pentacles"
  slug: "kings-of-pentacles"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
