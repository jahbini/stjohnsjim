# #-------- class start
renderer = class  dishwasher_to_the_prickly_tickly extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_dishwasher_to_the_prickly_tickly: =>
    T.div "#post-dishwasher-to-the-prickly-tickly.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Dishwasher to the Prickly Tickly"
          @bloviation()
...
db[id="59782449d3cfff7cc5f92644"] =
  ...
  created: "2010-11-11T16:04:08.000Z"
  lastEdited: "2010-11-11T17:34:53.000Z"
...
db[id="stjohnsjim/story/dishwasher-to-the-prickly-tickly"] =
  title: "Dishwasher to the Prickly Tickly"
  slug: "dishwasher-to-the-prickly-tickly"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
