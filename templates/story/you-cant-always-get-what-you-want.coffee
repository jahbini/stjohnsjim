# #-------- class start
renderer = class  you_cant_always_get_what_you_want extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_you_cant_always_get_what_you_want: =>
    T.div "#post-you-cant-always-get-what-you-want.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "You cant always get what you want"
          @bloviation()
...
db[id="stjohnsjim/story/you-cant-always-get-what-you-want"] =
  title: "You cant always get what you want"
  slug: "you-cant-always-get-what-you-want"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
