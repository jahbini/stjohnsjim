...
"""
  ...
  # 
  post_squirrel_tag: =>
    T.div "#post-squirrel-tag.article.article-type-post", id: "post-squirrel-tag", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Squirrel Tag"
          @bloviation()
