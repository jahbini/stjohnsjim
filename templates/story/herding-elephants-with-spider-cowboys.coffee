...
"""
  ...
  # 
  post_herding_elephants_with_spider_cowboys: =>
    T.div "#post-herding-elephants-with-spider-cowboys.article.article-type-post", id: "post-herding-elephants-with-spider-cowboys", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Herding Elephants with Spider Cowboys"
          @bloviation()
