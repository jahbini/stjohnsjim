...
"""
  ...
  # 
  post_the_big_rock_candy_new_year: =>
    T.div "#post-the-big-rock-candy-new-year.article.article-type-post", id: "post-the-big-rock-candy-new-year", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Big Rock Candy New Year"
          @bloviation()
