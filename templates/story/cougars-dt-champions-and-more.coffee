...
"""
  ...
  # 
  post_cougars_dt_champions_and_more: =>
    T.div "#post-cougars-dt-champions-and-more.article.article-type-post", id: "post-cougars-dt-champions-and-more", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Cougars, DT Champions, and more"
          @bloviation()
