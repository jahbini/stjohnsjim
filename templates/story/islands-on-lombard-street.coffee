# #-------- class start
renderer = class  islands_on_lombard_street extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_islands_on_lombard_street: =>
    T.div "#post-islands-on-lombard-street.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Islands on Lombard Street."
          @bloviation()
...
db[id="59782449d3cfff7cc5f92683"] =
  ...
  created: "2010-11-29T17:21:34.000Z"
  lastEdited: "2010-11-29T18:57:02.000Z"
  ...
  debug: ""
  id: "59782449d3cfff7cc5f92683"
  name: "Islands on Lombard Street."
#



db[id="stjohnsjim/story/islands-on-lombard-street"] =
  title: "Islands on Lombard Street."
  slug: "islands-on-lombard-street"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
