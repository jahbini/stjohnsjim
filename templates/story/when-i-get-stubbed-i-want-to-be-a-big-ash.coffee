...
"""
  ...
  # 
  post_when_i_get_stubbed_i_want_to_be_a_big_ash: =>
    T.div "#post-when-i-get-stubbed-i-want-to-be-a-big-ash.article.article-type-post", id: "post-when-i-get-stubbed-i-want-to-be-a-big-ash", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "When I Get Stubbed, I Want to be a Big Ash"
          @bloviation()
