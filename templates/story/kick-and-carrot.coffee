...
"""
  ...
  # 
  post_kick_and_carrot: =>
    T.div "#post-kick-and-carrot.article.article-type-post", id: "post-kick-and-carrot", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Kick and Carrot"
          @bloviation()
