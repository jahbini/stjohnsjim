# #-------- class start
renderer = class  kiting_over_to_wikileaks_with_one_jaw_tied_behind extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_kiting_over_to_wikileaks_with_one_jaw_tied_behind: =>
    T.div "#post-kiting-over-to-wikileaks-with-one-jaw-tied-behind.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Kiting over to WikiLeaks with one jaw tied behind"
          @bloviation()
