# #-------- class start
renderer = class  planning_for_pixies extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_planning_for_pixies: =>
    T.div "#post-planning-for-pixies.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Planning for Pixies."
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.blockquote =>
        T.blockquote ".right.key-sms.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: @voce I wonder what the magic word is? Remember when they picked “I” ?”"
        T.blockquote ".right.key-sms.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Do I? Everytime somebody said “I” we buzzed around the garden!"
        T.blockquote ".right.key-sms.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Cha! I hope it’s that fun again."
      T.p =>
      ...
      T.blockquote =>
        T.blockquote ".right.key-sms.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Animaniac? That is sooo 1993!"
        T.blockquote ".right.key-sms.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: It’s OK, It’s Old School homage"
...
db[id="59782449d3cfff7cc5f92688"] =
  ...
  created: "2010-12-12T16:14:23.000Z"
  lastEdited: "2011-11-23T12:14:38.000Z"
  published: "2010-12-12T18:03:03.000Z"
  embargo: "2017-12-31T23:59:59.000Z"
  captureDate: "2017-07-26T05:10:33.488Z"
  TimeStamp: "1501045833488"
  author: "Copyright 2010-2018 James A. Hinds: St. John's Jim -- King of Cascadia"
  debug: ""
  id: "59782449d3cfff7cc5f92688"
  name: "Planning for Pixies."
#



db[id="stjohnsjim/story/planning-for-pixies"] =
  title: "Planning for Pixies."
  slug: "planning-for-pixies"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
