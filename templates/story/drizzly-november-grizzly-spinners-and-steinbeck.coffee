# #-------- class start
renderer = class  drizzly_november_grizzly_spinners_and_steinbeck extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_drizzly_november_grizzly_spinners_and_steinbeck: =>
    T.div "#post-drizzly-november-grizzly-spinners-and-steinbeck.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Drizzly November, Grizzly Spinners and Steinbeck"
          @bloviation()
