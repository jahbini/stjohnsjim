# 
class roger_dojer_more_reliable_than_death extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_roger_dojer_more_reliable_than_death()
  # 
  # section post_roger_dojer_more_reliable_than_death
  # 
  post_roger_dojer_more_reliable_than_death: =>
    T.div "#post-roger-dojer-more-reliable-than-death.article.article-type-post", id: "post-roger-dojer-more-reliable-than-death", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Roger Dojer -- more reliable than death"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p =>
        ...
        T.raw ". You may remember it from {{{RogerObt}}}"
      T.p =>
        T.raw "Roger never caught on. You see,"
        T.span ".FBname", class: "FBname", => T.raw "Friend"
        T.raw ", {{{death:Death}}} was not in the manual of Preventative Maintenance, nor was it part of the Ph.D program in “minding your own business” that Roger was pursuing."
      T.p => T.raw "He moves a bit more stiffly now, since he is all dehydrated, and he’s covered in a white web of fungus. In fact, he hardly moves at all, In fact, if you saw him you would likely mistake him for a diseased bush."
      T.p => T.raw "So the residents of 3 Gunas LP were totally unaware of Roger out front with his Pickup and trailer."
      ...
      T.p => T.raw "Roger knocks on the door. Tommy answers and shouts: “Hey, Southwick, did you screw somebody? It wasn’t me this time. They dumped garbage on the porch again.”"
      T.p => T.raw "Southwick comes down from his tower keep, takes one look and says: “Roger! We thought you died over on the coast somewhere. Wassuuup? You look like a Santa Claus made out of an old two by four.”"
      T.p => T.raw "Roger’s eyes are completely covered by white webs, and he speaks in a raspy hiss: “Old lady kicked me out, said everything smelled musty. Life sux when your dead.”"
      T.p => T.raw "Tommy busts out, and says: “You better not have lost your pensions —You still collecting?”"
      T.p => T.raw "Roger says: “Yup, I just login and click. Everything A-OK.”"
      T.p => T.raw "Tommy says: “Welcome back, you can have your old room. I’ll get a fan: blow the smell right outdoors.”"
      T.p => T.raw "Southwick says: “Roger, look on the bright side, you got your old room back and you’ll never need to see a doctor!”"
      T.p => T.raw "Roger replies: “You’re right! I’ll take that off my schedule. {{{death:Death}}} happens. I owe you one.”"
      T.p => T.raw "Southwick turns to Tommy and says: “It’s always nice to be on the good side of death, isn’t it.”"
  # 
  # section header
  # 
  header: =>
...
page = new roger_dojer_more_reliable_than_death
