...
"""
  ...
  # 
  post_southwicks_report_on_als_crotch_rocket: =>
    T.div "#post-southwicks-report-on-als-crotch-rocket.article.article-type-post", id: "post-southwicks-report-on-als-crotch-rocket", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Southwick's report on Al's Crotch-Rocket"
          @bloviation()
