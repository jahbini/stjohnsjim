# #-------- class start
renderer = class  they_leave_the_west_behind extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_they_leave_the_west_behind: =>
    T.div "#post-they-leave-the-west-behind.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "They Leave the West Behind"
          @bloviation()
...
db[id="5978244ad3cfff7cc5f9269e"] =
  ...
  created: "2011-02-02T12:14:23.000Z"
  lastEdited: "2011-02-02T14:10:42.000Z"
...
db[id="stjohnsjim/story/they-leave-the-west-behind"] =
  title: "They Leave the West Behind"
  slug: "they-leave-the-west-behind"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
