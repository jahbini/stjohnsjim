...
class  the_st_johns_lighthouse_in_the_bardo extends stjohnsjimtemplate
  ...
  # 
  post_the_st_johns_lighthouse_in_the_bardo: =>
    T.div "#post-the-st-johns-lighthouse-in-the-bardo.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The St. John's Lighthouse in the Bardo"
          @bloviation()
