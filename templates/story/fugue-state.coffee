# #-------- class start
renderer = class  fugue_state extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_fugue_state: =>
    T.div "#post-fugue-state.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Fugue State"
          @bloviation()
