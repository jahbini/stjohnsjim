# #-------- class start
renderer = class  tastes_aromas_and_earthquakes extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_tastes_aromas_and_earthquakes: =>
    T.div "#post-tastes-aromas-and-earthquakes.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Tastes, Aromas and Earthquakes"
          @bloviation()
...
db[id="59782449d3cfff7cc5f9266e"] =
