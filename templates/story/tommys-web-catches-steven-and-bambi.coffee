...
"""
  ...
  # 
  post_tommys_web_catches_steven_and_bambi: =>
    T.div "#post-tommys-web-catches-steven-and-bambi.article.article-type-post", id: "post-tommys-web-catches-steven-and-bambi", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Tommy's Web Catches Steven and Bambi"
          @bloviation()
