# #-------- class start
class  jim_reads_tarot extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        T.raw "I have to apologize to Sarrah&nbsp;Verdier for not giving her credit for the very fun artwork of Sandy’s Halloween Dream. &nbsp;Sarrah is one of the very creative folk at the"
        T.a href: "http://www.cornerindustries.com/", => T.raw "North End Gallery"
        T.raw "."
      T.p =>
        T.img src: "http://stjohnsjim.com/bridgefight1.gif", alt: "The Cougar fights the Boss Grizzly Spinner"
      T.p =>
...
# ------- db start
db = {} unless db
db[id="59782449d3cfff7cc5f92632"] =
  ...
  accepted: true
  index: false
  sourcePath: "stjohnsjim/contents/story/jim-reads-tarot.md"
  headlines: []
  tags: []
