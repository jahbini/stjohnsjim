# #-------- class start
renderer = class  solitude_spiders_and_cougars extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_solitude_spiders_and_cougars: =>
    T.div "#post-solitude-spiders-and-cougars.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Solitude, Spiders, and Cougars"
          @bloviation()
  ...
  # 
  and_cougars: =>
    T.h3 "#and-cougars", => T.raw "And Cougars"
  # 
  # section spiderfest_2010
  # 
  spiderfest_2010: =>
    T.h3 "#spiderfest-2010", => T.raw "SpiderFest 2010"
  # 
  # section header
  # 
  # 
