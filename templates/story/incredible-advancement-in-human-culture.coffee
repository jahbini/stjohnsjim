...
class  incredible_advancement_in_human_culture extends stjohnsjimtemplate
  ...
  # 
  post_incredible_advancement_in_human_culture: =>
    T.div "#post-incredible-advancement-in-human-culture.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Incredible Advancement In Human Culture"
          @bloviation()
