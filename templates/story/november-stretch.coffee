# #-------- class start
renderer = class  november_stretch extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_november_stretch: =>
    T.div "#post-november-stretch.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "November Stretch"
          @bloviation()
  ...
  # 
  todays_tarot_reading_: =>
    T.h3 "#todays-tarot-reading-", => T.raw "Todays Tarot reading:"
  # 
  # section header
  # 
  # 
...
db[id="stjohnsjim/story/november-stretch"] =
  title: "November Stretch"
  slug: "november-stretch"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
