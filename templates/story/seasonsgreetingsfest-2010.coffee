...
"""
  ...
  # 
  post_seasonsgreetingsfest_2010: =>
    T.div "#post-seasonsgreetingsfest-2010.article.article-type-post", id: "post-seasonsgreetingsfest-2010", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "SeasonsGreetingsFest 2010"
          @bloviation()
