...
"""
  ...
  # 
  post_the_kung_fu_lions_roar: =>
    T.div "#post-the-kung-fu-lions-roar.article.article-type-post", id: "post-the-kung-fu-lions-roar", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Kung Fu Lion's Roar"
          @bloviation()
