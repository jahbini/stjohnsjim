# #-------- class start
renderer = class  the_bully_proof_dance extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  mainUnused: =>
    T.div "#main", =>
      @post_the_bully_proof_dance()
  # 
  # section post_the_bully_proof_dance
  # 
  post_the_bully_proof_dance: =>
    T.div "#post-the-bully-proof-dance.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Bully Proof Dance"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p =>
        ...
        T.raw ", Do you like to dance?&nbsp; Would you like to dance with some of the hunkiest partners around?&nbsp;&nbsp;Twice a week or more?&nbsp;The best of these dancers are humble, wise, fabulous with kids, all around great companions, lead or follow. They even have special festivals for members to gather respect for their skills."
      T.p => T.raw "People have fun with the dance. You know that dancing keeps you fit, dancing can keep you thin, this dance puts a dragon in your belly.&nbsp; You can learn to dance before, during or after a pregnancy: The ladies who own these dance halls tailor instruction to your needs."
      T.p => T.raw "The dance also gives you a gift of safety; you become bully-proof.&nbsp; Your mind will become undistracted by fear, real or imagined."
      T.p => T.raw "Kids even dance with pi&ntilde;atas for fun. And it makes the little monkeys bully-proof, too.&nbsp; Your kid won&rsquo;t be coming home with the bloody nose, and won&rsquo;t be starting any fights either."
      T.p => T.raw "These dance halls have strong female leaders who are taking over grass roots safety issues from &ldquo;the man.&rdquo;"
      T.p =>
        T.raw "Ok, it&rsquo;s fun, there are lots of partners, it&rsquo;s great health building exercise, kids love it, it makes you safe.&nbsp; And safety is key to serenity. &nbsp;That’s what Roger told us, yesterday, isn’t it,"
        T.span ".FBname", => T.raw "Friend"
        T.raw "?"
      T.p =>
      ...
      T.p => T.raw "But only if you like to dance.&nbsp; It will put a dragon in your belly."
  # 
  # section header
  # 
  # 
...
db[id="stjohnsjim/story/the-bully-proof-dance"] =
  title: "The Bully Proof Dance"
  slug: "the-bully-proof-dance"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
