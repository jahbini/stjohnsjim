...
"""
  ...
  # 
  post_the_bully_proof_dance: =>
    T.div "#post-the-bully-proof-dance.article.article-type-post", id: "post-the-bully-proof-dance", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Bully Proof Dance"
          @bloviation()
