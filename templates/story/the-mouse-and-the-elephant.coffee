...
"""
  ...
  # 
  post_the_mouse_and_the_elephant: =>
    T.div "#post-the-mouse-and-the-elephant.article.article-type-post", id: "post-the-mouse-and-the-elephant", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Mouse and The Elephant"
          @bloviation()
