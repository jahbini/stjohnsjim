...
"""
  ...
  # 
  post_ongoing_investigation: =>
    T.div "#post-ongoing-investigation.article.article-type-post", id: "post-ongoing-investigation", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Ongoing Investigation"
          @bloviation()
