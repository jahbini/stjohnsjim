...
"""
  ...
  # 
  post_a_hurricane_is_brewin: =>
    T.div "#post-a-hurricane-is-brewin.article.article-type-post", id: "post-a-hurricane-is-brewin", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "A Hurricane is Brewin"
          @bloviation()
  ...
  # 
  intruder_alert_: =>
    T.h2 "#intruder-alert-", id: "intruder-alert-", => T.raw "Intruder Alert!"
  # 
  # section header
  # 
  header: =>
