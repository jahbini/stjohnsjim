# #-------- class start
renderer = class  godda_love_an_old_dog extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_godda_love_an_old_dog: =>
    T.div "#post-godda-love-an-old-dog.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Godda Love an Old Dog"
          @bloviation()
