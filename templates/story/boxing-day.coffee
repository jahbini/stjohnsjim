...
"""
  ...
  # 
  post_boxing_day: =>
    T.div "#post-boxing-day.article.article-type-post", id: "post-boxing-day", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Boxing day"
          @bloviation()
