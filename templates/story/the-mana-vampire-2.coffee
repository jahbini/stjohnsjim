...
"""
  ...
  # 
  post_the_mana_vampire_2: =>
    T.div "#post-the-mana-vampire-2.article.article-type-post", id: "post-the-mana-vampire-2", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Mana Vampire - 2"
          @bloviation()
