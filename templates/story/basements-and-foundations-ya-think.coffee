# #-------- class start
renderer = class  basements_and_foundations_ya_think extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_basements_and_foundations_ya_think: =>
    T.div "#post-basements-and-foundations-ya-think.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Basements and Foundations, Ya Think?"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        ...
        T.blockquote ".right.key-sms.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Even Heroin Hookers have ideas of romance"
        T.blockquote ".right.key-sms.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says:  “Tommy is so sweet.”"
      ...
      T.p =>
        ...
        T.blockquote ".right.key-sms.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Ha, 120 hour mo’ betta’!"
        T.blockquote ".right.key-sms.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Simple Southwick! LOLZ."
      T.p =>
  ...
  # 
  let_s_join_the_three_wise_men_over_at_3_gunas_loop: =>
    T.h3 "#let-s-join-the-three-wise-men-over-at-3-gunas-loop", => T.raw "Let’s join the Three Wise Men over at 3 Gunas Loop"
  # 
  # section header
  # 
  # 
