# #-------- class start
renderer = class  and_the_pursuit_of_happiness extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_and_the_pursuit_of_happiness: =>
    T.div "#post-and-the-pursuit-of-happiness.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "And the Pursuit of Happiness"
          @bloviation()
...
db[id="stjohnsjim/story/and-the-pursuit-of-happiness"] =
  title: "And the Pursuit of Happiness"
  slug: "and-the-pursuit-of-happiness"
  category: "story"
  site: "stjohnsjim"
