...
"""
  ...
  # 
  post_put_the_blood_of_the_lamb_in_your_throat: =>
    T.div "#post-put-the-blood-of-the-lamb-in-your-throat.article.article-type-post", id: "post-put-the-blood-of-the-lamb-in-your-throat", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Put the Blood of the Lamb in Your Throat"
          @bloviation()
