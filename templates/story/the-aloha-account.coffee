# #-------- class start
renderer = class  the_aloha_account extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  mainUnused: =>
    T.div "#main", =>
      @post_the_aloha_account()
  # 
  # section post_the_aloha_account
  # 
  post_the_aloha_account: =>
    T.div "#post-the-aloha-account.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Aloha Account"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "I have run into lean times lately: until I get my Honorary Ph.D. in Literature from CRUD University and have my best selling novels carry me into economic bliss, I have to deal with limited income and OMG debts."
      T.p => T.raw "None of this should be news to anyone (if it is, then pretend you didn&rsquo;t hear it, OK?)"
      ...
      T.p => T.raw "With this kind of budgeting, I can be assured of good food, ale or a book, maybe an occasional mani-pedi. Pre-payment. I can only do that with merchants I trust. Even so, if a merchant goes belly up, my loss is limited."
      T.p => T.raw "It&rsquo;s still a budget. But it&rsquo;s a lot easier than me keeping track of my money: Merchants are well set up with the kind of folks who know how to add and subtract, thank goodness."
      T.p => T.raw "This seems to work for the merchants here in St. John&rsquo;s. Value for value."
      ...
      T.p => T.raw "That&rsquo;s aloha, the feeling that you are being treated like family."
      ...
      T.p =>
        ...
        T.raw ", Who has impacted your life in small but consistently beneficial ways whether you were in need or not? One that you don&rsquo;t see often enough anymore, or who you can&rsquo;t repay for all those kindnesses?"
      T.p => T.raw "Who would you want to set up an Aloha Account for? Or have you already?"
  # 
  # section header
  # 
  # 
...
db[id="59782449d3cfff7cc5f92623"] =
  ...
  created: "2011-05-25T17:55:05.000Z"
  lastEdited: "2011-05-25T18:26:37.000Z"
...
db[id="stjohnsjim/story/the-aloha-account"] =
  title: "The Aloha Account"
  slug: "the-aloha-account"
  category: "story"
  site: "stjohnsjim"
