...
class southwick_in_the_slammer extends stjohnsjimtemplate
  ...
  # 
  post_southwick_in_the_slammer: =>
    T.div "#post-southwick-in-the-slammer.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Southwick in the Slammer??!!!"
          @bloviation()
