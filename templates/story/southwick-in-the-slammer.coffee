# 
class southwick_in_the_slammer extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_southwick_in_the_slammer()
  # 
  # section post_southwick_in_the_slammer
  # 
  post_southwick_in_the_slammer: =>
    T.div "#post-southwick-in-the-slammer.article.article-type-post", id: "post-southwick-in-the-slammer", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Southwick in the Slammer??!!!"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "I saw Southwick getting off the 75 early this morning. Odd, I had not seen Southwick for a while. He had not showered in several days and had a tired, but agitated look."
      T.p => T.raw "Me: &quot;Hey, Southwick, buddy, wassup?&quot;"
      T.p => T.raw "Southwick: &quot;Oh, no. You. What do you want?&quot;"
      T.p => T.raw "Me: &quot;Southwick? Is that you? I&rsquo;ve never heard you talk like that.&quot;"
      T.p => T.raw "He: &quot;They kicked me out at 3AM! I had to wait forever for the first bus. And cold!?! &nbsp;I froze my nuts off.&quot;"
      T.p => T.raw "Me: &quot;Who did? Where were you?? Lemme buy you grits and eggs at the James John Cafe.&quot;"
      T.p => T.raw "He blubbered a thank you and kind of fell in a heap. I dragged him across the street to the cafe&rsquo;s secret location where he told me the most curious story."
      ...
      T.p => T.raw "Southwick went outside thinking nothing was out of the ordinary (except for the unicorns playing beneath the cedars of Pier Park.) &ldquo;Damned false Spring, those Unicorns will catch their death..&rdquo;"
      T.p =>
        T.raw "&mdash; and then"
        T.em => T.raw "Pow"
        T.raw ","
        T.strong =>
          T.em => T.raw "Bang"
        T.raw ", ! ! ! Batman ! ! ! — &nbsp; Face down on the concrete mattress. A huge boot was put on his neck. Then a long silence. &ldquo;Hey, what&rsquo;s wrong with this thing.&rdquo;"
      ...
      T.p => T.raw "At this the officers glanced at each other nervously, backing slowly away until they bumped into the walls of the room."
      T.p => T.raw "&ldquo;Remember Ralph? He got slammed with a warrantee violation three weeks before his retirement&quot;"
      T.p => T.raw "&ldquo;OMG. Poor bastard, not even the union could help.&rdquo; None of them wanted to be involved in unlawful warrantee violation."
      ...
      T.p => T.raw "He was released on his own forgetfulness and challenged to remember any of the preceding except his own humiliation. &nbsp;He complied easily."
      T.p => T.raw "I felt I had to rescue Southwick from this negative spiral of self hate:"
      T.p => T.raw "I said: &quot;Southwick, those &quot;mouthpiece&quot; skills that Tommy has taught you are awesome. &nbsp;You have convinced the cops that you are the the son of the mouth.&quot;"
      T.p =>
        T.span ".FBname", class: "FBname", => T.raw "Friend"
        T.raw ", need I remind you that Tommy is Professor of Ethics at Waterfront U. &nbsp;From now on, Southwick is under &ldquo;special protection.&rdquo; &nbsp; St. John&rsquo;s now has another famous criminal: &quot;Sludge&quot; Southwick.&quot;"
        T.br()
        T.raw "&nbsp;"
  # 
  # section header
...
page = new southwick_in_the_slammer
