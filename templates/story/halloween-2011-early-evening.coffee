# #-------- class start
renderer = class  halloween_2011_early_evening extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_halloween_2011_early_evening: =>
    T.div "#post-halloween-2011-early-evening.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Halloween 2011 -- Early Evening"
          @bloviation()
...
db[id="59782449d3cfff7cc5f92630"] =
