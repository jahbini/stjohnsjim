# #-------- class start
class  seeking_fertile_ground extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  main: =>
    T.div "#main", =>
      @post_seeking_fertile_ground()
  # 
  # section post_seeking_fertile_ground
  # 
  post_seeking_fertile_ground: =>
    T.div "#post-seeking-fertile-ground.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Seeking Fertile Ground"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p => T.raw "Kids brains are fertile ground. Are they really interested in the innuendos of social networking?&nbsp; Or to idolize bad behavior? &nbsp;Or both?"
      ...
      T.p => T.raw "The district of St. John&rsquo;s is fertile ground.&nbsp; Most I meet in St. John’s are dented, recycled, reused.&nbsp; We are the second-hand store of cities, and we are not giving up.&nbsp; In fact, the energies of our visionaries increase daily."
      ...
      T.p =>
        T.raw "I went down to the food carts after hours and found the pro-amoeba forces giving &ldquo;the pitch&rdquo; to Peggy, owner of the"
        T.em => T.raw "Peggy&rsquo;s Pills"
        T.raw "wagon."
      T.p =>
        T.raw "Peggy wants me to mention her slogan: &ldquo;"
        T.em => T.raw "Nutritionally complete, Roughage at your feet"
        T.raw ".&rdquo;&nbsp; The floor is covered in free-range organic sawdust.&nbsp; A bit too rustic for my tastes, but St. John&rsquo;s will try anything: we even have a drive-though Hookah Lounge.&nbsp; St John&rsquo;s is fertile ground for crazy ideas. &nbsp;That’s why I’m here."
      ...
      T.p =>
        T.raw "Peggy says: &ldquo;"
        T.em =>
          T.strong => T.raw "Bring it on"
        T.raw ", I won&rsquo;t be intimidated into serving them,&nbsp; I don&rsquo;t care if the rest of Portland serves &lsquo;em, I don&rsquo;t want their dirty money!&nbsp; Hell, they don&rsquo;t"
        T.em =>
          T.strong => T.raw "HAVE"
        T.raw "any money.&rdquo;"
      T.p => T.raw "The Metro Makers leave mumbling Tommy&rsquo;s name.&nbsp; I definitely need to follow up with Southwick."
...
#-------- class end
page = new seeking_fertile_ground
rendered =  T.render page.html
# ------- db start
db = {} unless db


db[id="59782449d3cfff7cc5f92622"] =
