...
"""
  ...
  # 
  post_seeking_fertile_ground: =>
    T.div "#post-seeking-fertile-ground.article.article-type-post", id: "post-seeking-fertile-ground", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Seeking Fertile Ground"
          @bloviation()
