...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_st_john_and_the_diamonds()
  # 
  # section post_st_john_and_the_diamonds
  # 
  post_st_john_and_the_diamonds: =>
    T.div "#post-st-john-and-the-diamonds.article.article-type-post", id: "post-st-john-and-the-diamonds", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "St. John and the Diamonds"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.blockquote =>
        T.p =>
          T.raw "Nature’s first green is gold,&#8232;"
          T.br()
          T.raw "Her hardest hue to hold.&#8232;"
          T.br()
          T.raw "Her early leaf’s a flower;&#8232;"
          T.br()
          T.raw "But only so an hour.&#8232;"
          T.br()
          T.raw "Then leaf subsides to leaf.&#8232;"
          T.br()
          T.raw "So Eden sank to grief,"
          T.br()
          T.raw "So dawn goes down to day.&#8232;"
          T.br()
          T.raw "Nothing gold can stay. &mdash; Robert Frost A virgin new year brings to mind Eden gone to grief, then we inhale our breath soon for Nature&rsquo;s hardest hue. It&rsquo;s coming. Rainfall will provide a drumroll entrance for her."
      T.p => T.raw "Our new year will see many new businesses start as gold: A hand-shake and newspapers on the windows gives way to a flurry of activity, and may come to grief in weeks. As CorpoChrist might have said: &ldquo;We will always have failing businesses&rdquo;."
      T.p => T.raw "And we could easily say that St. John&rsquo;s was an economic Eden come to grief, That is equally true of many neighborhoods, nothing special there."
      ...
      T.p => T.raw "Crouchley Plumbing may still need the wagon wheel railings and horse tie rings that line the street curbs here and there in St. John’s."
      T.p => T.raw "Wayne&rsquo;s barber shop has been home to Wayne since he walked down the gangway of the Battleship California after WWII. He still cuts hair every day and has a full plate of regular customers."
      T.p => T.raw "The 50’s music at Patti’s Home Plate or&nbsp;the quality of the food at the James John Cafe is as reliable as our constant pursuit of Politically Correct language. &nbsp;(I’m betting the PC stuff goes out of style quicker)"
      T.p => T.raw "The popcorn popper that generated all the business last year is still going strong in St. John’s. &nbsp;It will generate more this coming year, and more of those businesses have a chance to dip into our abundant resource of workers."
      T.p => T.raw "How&rsquo;s that for the staying power of diamond, Mr. Frost? Even though after enough time, Wayne will close his doors, but until the bridge crumbles to dust, St. John&rsquo;s has diamonds."
      T.p => T.raw "Business as usual will be on us soon. &nbsp;We will inhale the New Year, and await Nature&rsquo;s hardest hue to hold…"
      T.p => T.raw "Opportunities abound. Just know that the value may just last a bit longer than Mr. Frost may suggest."
      T.p => T.raw "You don&rsquo;t have to be as tenacious as Wayne, or as stunning as our Bridge. But it helps.&nbsp;&nbsp;"
  # 
  # section header
  # 
  header: =>
