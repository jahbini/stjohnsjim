...
"""
  ...
  # 
  post_the_toy_store_that_kills: =>
    T.div "#post-the-toy-store-that-kills.article.article-type-post", id: "post-the-toy-store-that-kills", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Toy Store that Kills"
          @bloviation()
