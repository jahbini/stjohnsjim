...
"""
  ...
  # 
  post_grand_feng_shui_station: =>
    T.div "#post-grand-feng-shui-station.article.article-type-post", id: "post-grand-feng-shui-station", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Grand Feng Shui Station"
          @bloviation()
