...
"""
  ...
  # 
  post_st_johns_tweets: =>
    T.div "#post-st-johns-tweets.article.article-type-post", id: "post-st-johns-tweets", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "St Johns Tweets"
          @bloviation()
