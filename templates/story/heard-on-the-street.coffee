...
"""
  ...
  # 
  post_heard_on_the_street: =>
    T.div "#post-heard-on-the-street.article.article-type-post", id: "post-heard-on-the-street", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Heard on the Street"
          @bloviation()
