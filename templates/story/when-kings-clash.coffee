...
"""
  ...
  # 
  post_when_kings_clash: =>
    T.div "#post-when-kings-clash.article.article-type-post", id: "post-when-kings-clash", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "When Kings Clash"
          @bloviation()
