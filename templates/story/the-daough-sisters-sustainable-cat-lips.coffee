# #-------- class start
renderer = class  the_daough_sisters_sustainable_cat_lips extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  mainUnused: =>
    T.div "#main", =>
      @post_the_daough_sisters_sustainable_cat_lips()
  # 
  # section post_the_daough_sisters_sustainable_cat_lips
  # 
  post_the_daough_sisters_sustainable_cat_lips: =>
    T.div "#post-the-daough-sisters-sustainable-cat-lips.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Daough Sister's Sustainable Cat Lips"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p =>
        ...
        T.raw ", I have noticed some neighborhood cats with red or purple lips. I thought you might want to know more."
      ...
      T.p => T.raw "Winnie is likely the best &ldquo;found material&rdquo; artisan in Oregon: she can turn a toilet float into a kid&rsquo;s party balloon. And Pathy has a green thumb that can make a horseshoe grow roots."
      ...
      T.p => T.raw "I thought better than to ask how to prepare any of those 80 ways. I had to sit through about three of them anyway. Don&rsquo;t ask, but I&rsquo;ll likely never eat any of Winnie&rsquo;s &ldquo;Blood Orange&rdquo; cookies."
      T.p => T.raw "I had trouble following all that Pathy and Winnie had to say because they both were watching TV. Different channels. At the same time. And talking to me, to their TV sets, and to each other at the same time."
      T.p =>
        T.raw "Pathy tunes into a daytime talk show with a guy who specializes in interviewing sociopaths, arranging family interventions with sociopaths, and generally recognizing it as the natural behavior that it is: &ldquo;Let&rsquo;s remove the stigma of Sociopathy&rdquo; &mdash; That day he is interviewing Adaman Eaves, the ousted finance minister of the National Bank of Cash. &ldquo;Ever since I read"
        T.a href: "http://www.amazon.com/Snakes-Suits-When-Psychopaths-Work/dp/0060837721", => T.raw "Snakes in Suits"
        T.raw "I realized I wasn&rsquo;t ALONE! That there were people with the same condition, and I no longer felt the victim of my &ldquo;terrible malady&rdquo; &mdash; I broke down and cried when I realized I was a sociopath and I could be proud of it!&rdquo;"
      T.p => T.raw "All during this, Pathy was saying things to the TV like &ldquo;My Sam did that too.&rdquo; or &ldquo;It&rsquo;s OK. Lots of them feel they are just doing their duty, too.&rdquo; Or even: &ldquo;Keep on trying!&rdquo; Pathy&rsquo;s cats pawed the screen every so often."
      ...
      T.p => T.raw "I think it explains the sustainable supply of red and purple lipstick for our neighborhood cats. Just thank the Daough Sisters."
  # 
  # section header
  # 
  # 
...
db[id="stjohnsjim/story/the-daough-sisters-sustainable-cat-lips"] =
  title: "The Daough Sister's Sustainable Cat Lips"
  slug: "the-daough-sisters-sustainable-cat-lips"
  category: "story"
  site: "stjohnsjim"
