# #-------- class start
renderer = class  the_gift_of_who_are_you extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_the_gift_of_who_are_you: =>
    T.div "#post-the-gift-of-who-are-you.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "The Gift of &quot;Who Are You?&quot;"
          @bloviation()
