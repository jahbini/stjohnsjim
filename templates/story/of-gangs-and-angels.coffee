...
"""
  ...
  # 
  post_of_gangs_and_angels: =>
    T.div "#post-of-gangs-and-angels.article.article-type-post", id: "post-of-gangs-and-angels", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Of Gangs and Angels"
          @bloviation()
