# #-------- class start
renderer = class  truck_fight extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_truck_fight: =>
    T.div "#post-truck-fight.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Truck Fight"
          @bloviation()
