# #-------- class start
renderer = class  lonesome_al_and_the_space_door extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_lonesome_al_and_the_space_door: =>
    T.div "#post-lonesome-al-and-the-space-door.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Lonesome Al and the Space Door"
          @bloviation()
  ...
  # 
  caption_we_transport_anything_anywhere_in_the_l_quadrant_: =>
    T.h2 "#caption-we-transport-anything-anywhere-in-the-l-quadrant-", => T.raw "Caption: We transport anything, anywhere in the L-quadrant."
  # 
  # section header
  # 
  # 
...
db[id="59782449d3cfff7cc5f9267c"] =
  ...
  created: "2011-01-14T13:29:44.000Z"
  lastEdited: "2011-01-14T17:22:28.000Z"
  ...
  debug: ""
  id: "59782449d3cfff7cc5f9267c"
  name: "Lonesome Al and the Space Door"
#



db[id="stjohnsjim/story/lonesome-al-and-the-space-door"] =
  title: "Lonesome Al and the Space Door"
  slug: "lonesome-al-and-the-space-door"
  category: "story"
  site: "stjohnsjim"
