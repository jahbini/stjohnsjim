# #-------- class start
class  excuse_my_re_use extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  main: =>
    T.div "#main", =>
      @post_excuse_my_re_use()
  # 
  # section post_excuse_my_re_use
  # 
  post_excuse_my_re_use: =>
    T.div "#post-excuse-my-re-use.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Excuse My Re-Use!"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "Attention Deficit Disorder is a great source of humor:"
      T.p => T.raw "How many ADD kids does it take to change a light bulb? Hey, I know, let&rsquo;s go ride our bikes!"
      T.p => T.raw "My grandfather managed his aging years with the observation: &quot;I’ve hit so many rocks in my path, my plow is blunted&quot;"
      ...
      T.p =>
        ...
        T.a href: "http://audubonportland.org/local-birding/swiftwatch", => T.raw "Grade School Chimne"
        T.raw "y. Tree-huggers that we are, we likely will have human-tree marriages sooner than California."
      ...
      T.p => T.raw "That&rsquo;s St. John&rsquo;s, Portland, Oregon on this glorious Summer of April 2, 2011 &mdash; It&rsquo;s a Jaywalkers Paradise!"
      T.p => T.raw "Jim’s Note - This one took several days, I want to thank S. McDonald for her suggestion of the &quot;million dollar marble,&quot; which sparked the proper St. John’s ending, and PapaDon for his support and encouragement."
  # 
  # section header
  # 
  # 
...
db[id="59782449d3cfff7cc5f92631"] =
  ...
  snippets: "{}"
  memberOf: []
  created: "2011-04-02T10:42:01.000Z"
  lastEdited: "2011-04-02T12:49:33.000Z"
...
db[id="stjohnsjim/story/excuse-my-re-use"] =
  title: "Excuse My Re-Use!"
  slug: "excuse-my-re-use"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
