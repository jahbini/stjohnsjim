# 
class angel_flakes extends stjohnsjimtemplate
  # 
  # section html
  # 
  html: =>
...
"""
  ...
  main: =>
    T.div "#main", id: "main", =>
      @post_angel_flakes()
  # 
  # section post_angel_flakes
  # 
  post_angel_flakes: =>
    T.div "#post-angel-flakes.article.article-type-post", id: "post-angel-flakes", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Angel Flakes"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "Mr. Weatherman:"
      T.p => T.raw "&nbsp;&nbsp; Ha! The sky didn&rsquo;t fall, Chicken Little!&nbsp; The one to three inches of snow was the latest of overblown stories.&nbsp; But we did get cold. &nbsp;The very same weathermen say It is not supposed to thaw today at all.&nbsp; Now that&rsquo;s worthy.&nbsp; Cold and dry. &nbsp; Much better than a PNW day of&nbsp;cold and wet."
      ...
      T.p =>
        T.raw "Actually, you might pray for and honor YOUR sphincters, not mine.&nbsp; You may consider that each part of you responds to praise and warmth just as your ego does.&nbsp; As above, so below:&nbsp; We are full of reward responsive neural centers. &nbsp;"
        T.a href: "http://www.ouuf.org/sermons/my-body.html", => T.raw "Praise activated"
        T.raw ".&nbsp; Praise yourself and all your 1001 parts, cause you are, they are, fabulous,"
        T.span ".FBname", class: "FBname", => T.raw "Friend"
        T.raw ". &nbsp;Praise the bladder, too."
      T.p => T.raw "The walk into town was punctuated by several mysterious, unrelated events.&nbsp; Swirling snowflakes in the sunlight &mdash; not a cloud in the sky. But these were not your traditional wind blown snow. &nbsp;Tiny, nearly invisible except for angelic glints:&nbsp; Angel Flakes dancing in the street.&nbsp; A good portent."
      T.p =>
        T.raw "In Honolulu the rain sometimes comes down like that -"
        T.a href: "http://cf.synergylearning.org/displayarticle.cfm?selectedarticle=513", => T.raw "‘Awa"
        T.raw ":&nbsp; The tiniest drops with no cloud in the sky: The"
        T.a href: "http://www.portaloha.com/SecretsOfHawaii/PaliLookout.htm", => T.raw "Pali Lookout"
        T.raw "makes a perfect atomizer as the wind sprays honolulu with the sweetest Angel Kisses.&nbsp; Very Nice."
      T.p =>
        T.raw "A woman down the street shouted &ldquo;Thanks for your Stories&rdquo; &mdash; I&rsquo;m sorry I didn&rsquo;t recognize you, was that you,"
        T.span ".FBname", class: "FBname", => T.raw "Friend"
        T.raw "?"
      T.p => T.raw "The leaves in the park crunched again as I walked over them.&nbsp; Even the blades of grass attempted to support me &mdash; the crunch signaling their failure.&nbsp; I salute you, fallen blades of grass, you attempted the impossible, and I honor your part in life."
      T.p => T.raw "I&rsquo;m asked to take sides by the City Council.&nbsp; Who in their right mind would care what St John&rsquo;s Jim thinks?&nbsp; Do they think somebody actually reads these e-mails?&nbsp; Hmm.&nbsp; The power of the pen &mdash; May I avoid poking it in my own eye."
      T.p =>
        T.raw "These are all examples of Angel Flakes.&nbsp; Tiny, almost un-noticible nice things.&nbsp; All around. Notice them!&nbsp; Take full advantage of encouragement, beauty, nicer than expected weather, hints and apparitions of sweet memories.&nbsp; Each one is a tiny, tiny sip of a"
        T.a href: "http://blissblvd.com/the-tarot/three-of-cups/", => T.raw "three of cups"
        T.raw "pleasure &mdash; the pleasure that is gone in a moment. Chasing pleasure is doomed, but enjoying pleasure is not. &nbsp; Add these joys up, and you are a joy magnet."
      T.p => T.raw "So look for these Angel Flakes, they are a nice ally in the fight against anger or depression.&nbsp; Your sphincters will approve."
  # 
  # section header
  # 
  header: =>
