# #-------- class start
renderer = class  st_johns_jim_and_the_st_johns_lighthouse extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  mainUnused: =>
    T.div "#main", =>
      @post_st_johns_jim_and_the_st_johns_lighthouse()
  # 
  # section post_st_johns_jim_and_the_st_johns_lighthouse
  # 
  post_st_johns_jim_and_the_st_johns_lighthouse: =>
    T.div "#post-st-johns-jim-and-the-st-johns-lighthouse.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "St. John's Jim and the St. John's Lighthouse"
          @bloviation()
...
db[id="stjohnsjim/story/st-johns-jim-and-the-st-johns-lighthouse"] =
  title: "St. John's Jim and the St. John's Lighthouse"
  slug: "st-johns-jim-and-the-st-johns-lighthouse"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
