...
"""
  ...
  # 
  post_st_johns_jim_and_the_st_johns_lighthouse: =>
    T.div "#post-st-johns-jim-and-the-st-johns-lighthouse.article.article-type-post", id: "post-st-johns-jim-and-the-st-johns-lighthouse", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "St. John's Jim and the St. John's Lighthouse"
          @bloviation()
  ...
  # 
  nobrow_: =>
    T.h3 "#nobrow-", id: "nobrow-", => T.raw "NoBrow."
  # 
  # section header
  # 
  header: =>
