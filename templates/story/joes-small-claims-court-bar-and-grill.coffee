...
"""
  ...
  # 
  post_joes_small_claims_court_bar_and_grill: =>
    T.div "#post-joes-small-claims-court-bar-and-grill.article.article-type-post", id: "post-joes-small-claims-court-bar-and-grill", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Joe's Small Claims Court / Bar and Grill"
          @bloviation()
