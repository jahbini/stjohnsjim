...
"""
  ...
  # 
  post_the_great_harvest_moon_part_2: =>
    T.div "#post-the-great-harvest-moon-part-2.article.article-type-post", id: "post-the-great-harvest-moon-part-2", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Great Harvest Moon - Part 2"
          @bloviation()
