# #-------- class start
renderer = class  simple_scientific_reality extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_simple_scientific_reality: =>
    T.div "#post-simple-scientific-reality.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Simple Scientific Reality"
          @bloviation()
...
db[id="59782449d3cfff7cc5f92678"] =
  ...
  created: "2010-10-13T11:34:24.000Z"
  lastEdited: "2010-10-13T12:40:30.000Z"
  ...
  debug: ""
  id: "59782449d3cfff7cc5f92678"
  name: "Simple Scientific Reality"
#



db[id="stjohnsjim/story/simple-scientific-reality"] =
  title: "Simple Scientific Reality"
  slug: "simple-scientific-reality"
  category: "story"
  site: "stjohnsjim"
