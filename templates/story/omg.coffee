# #-------- class start
renderer = class  omg extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_omg: =>
    T.div "#post-omg.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "OMG"
          @bloviation()
...
db[id="59782449d3cfff7cc5f92667"] =
  title: "OMG"
  slug: "omg"
  category: "story"
  site: "stjohnsjim"
  ...
  created: "2010-10-31T15:51:07.000Z"
  lastEdited: "2010-10-31T16:39:16.000Z"
  ...
  debug: ""
  id: "59782449d3cfff7cc5f92667"
  name: "OMG"
#



db[id="stjohnsjim/story/omg"] =
  title: "OMG"
  slug: "omg"
  category: "story"
  site: "stjohnsjim"
