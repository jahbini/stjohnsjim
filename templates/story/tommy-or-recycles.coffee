...
"""
  ...
  # 
  post_tommy_or_recycles: =>
    T.div "#post-tommy-or-recycles.article.article-type-post", id: "post-tommy-or-recycles", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Tommy, OR Recycles"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", id: "bloviation", class: "article-entry contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p => T.raw "Tommy&rsquo;s word salad seems to make sense, and that scares me.&nbsp; I decide to leave 1950’s Tommy, OR, and take my exit through the front door of 3 Gunas Lp.&nbsp; As I leave, I hear something about the team of Nobel prize winners he had to manage."
      T.p =>
