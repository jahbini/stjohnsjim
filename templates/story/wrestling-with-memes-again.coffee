# #-------- class start
renderer = class  wrestling_with_memes_again extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_wrestling_with_memes_again: =>
    T.div "#post-wrestling-with-memes-again.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Wrestling with Memes Again"
          @bloviation()
...
db[id="stjohnsjim/story/wrestling-with-memes-again"] =
  title: "Wrestling with Memes Again"
  slug: "wrestling-with-memes-again"
  category: "story"
  site: "59781236d3cfff7cc5f92609"
