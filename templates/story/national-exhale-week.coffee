...
"""
  ...
  # 
  post_national_exhale_week: =>
    T.div "#post-national-exhale-week.article.article-type-post", id: "post-national-exhale-week", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "National Exhale Week"
          @bloviation()
