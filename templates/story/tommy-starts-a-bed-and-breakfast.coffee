...
class  tommy_starts_a_bed_and_breakfast extends stjohnsjimtemplate
  ...
  # 
  post_tommy_starts_a_bed_and_breakfast: =>
    T.div "#post-tommy-starts-a-bed-and-breakfast.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Tommy Starts A Bed and Breakfast"
          @bloviation()
...
db[id="5978244ad3cfff7cc5f9269c"] =
