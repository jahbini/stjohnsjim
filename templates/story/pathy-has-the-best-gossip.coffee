...
"""
  ...
  # 
  post_pathy_has_the_best_gossip: =>
    T.div "#post-pathy-has-the-best-gossip.article.article-type-post", id: "post-pathy-has-the-best-gossip", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Pathy Has the Best Gossip"
          @bloviation()
