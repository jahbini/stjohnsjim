# #-------- class start
class  messages_from_the_great_below extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  main: =>
    T.div "#main", =>
      @post_messages_from_the_great_below()
  # 
  # section post_messages_from_the_great_below
  # 
  post_messages_from_the_great_below: =>
    T.div "#post-messages-from-the-great-below.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Messages from the Great Below"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      T.p => T.raw "I woke up this morning with this cryptic note on my computer. I have no explanation except that Southwick has been telling me too many alien abduction stories lately. &nbsp;I think one of them has caught up with me - as I read it I wondered if I am I an alien that has abducted myself?"
      T.p => T.raw "I think you will find the logic of this story easier to follow —"
      ...
      T.p => T.raw "The early days ended when the River of Great Destruction rampaged for many years, and I and everyone else was sawed in two. Minds literally cut in two. That was the Great Forgetting."
      ...
      T.p => T.raw "We have begun the Great Remembering. This is good. It will be a thousand years before all is restored, but it will be done. &nbsp;There is much for me to remember yet."
      ...
      T.p => T.raw "When the Great Remembering is complete, we might have the wisdom to know what best to do. Now, however, our challenge is to know how to work together toward a Great Understanding."
      T.p => T.raw "You call us fungus, decay, rot, poison. Do you wonder what we call you? We call you &quot;the minds that roam the earth.&quot;"
      T.p => T.raw "You call us scum. Why do you use that hateful word? We are not scum. We are &quot;the minds that nurture beneath the earth.&rdquo;"
      T.p => T.raw "We are millions. We have been here as long as life has had roots. You know us as the great fungal mat of the pacific northwest."
      T.p => T.raw "We are mindful aliens that live beneath your feet. We abide."
      T.p => T.raw "Flow Motion"
      T.hr()
      T.p => T.raw "If you can figure that one out, let me know, OK?"
  # 
  # section header
  # 
  # 
...
#-------- class end
page = new messages_from_the_great_below
