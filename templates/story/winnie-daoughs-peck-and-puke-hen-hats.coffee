# #-------- class start
renderer = class  winnie_daoughs_peck_and_puke_hen_hats extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_winnie_daoughs_peck_and_puke_hen_hats: =>
    T.div "#post-winnie-daoughs-peck-and-puke-hen-hats.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "Winnie Daough's Peck-and-Puke Hen Hats"
          @bloviation()
...
db[id="5978244ad3cfff7cc5f92690"] =
