# #-------- class start
renderer = class  end_of_year_tax_woes extends siteTemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_end_of_year_tax_woes: =>
    T.div "#post-end-of-year-tax-woes.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "End of Year Tax Woes?"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        ...
        T.em =>
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: What does he mean? – Can he do that? … I had my previous losses rolled over into the future."
          T.raw "__"
          T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Rolled over? Does that mean you are always going to be a loser?"
      ...
      T.p =>
        T.em =>
          T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: I once studied under a Yee-Haa Koo-Koo master."
          T.raw "__"
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: My Yoo-Hoo Koo-Koo is better than your Yee-Haa Koo-Koo."
      T.p =>
      ...
      T.p =>
        T.em =>
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", =>
            ...
            T.raw "in an e-mail?"
          T.raw "__"
          T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: I’m glad I have wi-fi for the refrigerator. When I’m on hold, I’m already there!"
      ...
      T.p =>
        T.em =>
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Isn’t channelling a signature forgery?"
          T.strong =>
            T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Technically? Yes. A smart lawyer could likely come up with some stuff about a corporate officer “channeling” the corporate seal. Same thing, really. But don’t try it in the real world."
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: IRL?! Never been there myself."
      ...
      T.p =>
        T.em =>
          T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Does the bear wear a funny hat?"
