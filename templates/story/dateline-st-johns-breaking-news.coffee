...
"""
  ...
  # 
  post_dateline_st_johns_breaking_news: =>
    T.div "#post-dateline-st-johns-breaking-news.article.article-type-post", id: "post-dateline-st-johns-breaking-news", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Dateline: St. John's! Breaking News!"
          @bloviation()
  ...
  # 
  tommy_s_hobby: =>
    T.h2 "#tommy-s-hobby", id: "tommy-s-hobby", => T.raw "Tommy’s Hobby"
  # 
  # section tweeker_s_report_ghosts_
  # 
  tweeker_s_report_ghosts_: =>
    T.h2 "#tweeker-s-report-ghosts-", id: "tweeker-s-report-ghosts-", => T.raw "Tweeker’s Report Ghosts!"
  # 
  # section first_page_throntle_
  # 
  first_page_throntle_: =>
    T.h2 "#first-page-throntle-", id: "first-page-throntle-", => T.raw "First Page: Throntle!"
  # 
  # section header
  # 
  header: =>
