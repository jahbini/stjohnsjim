# #-------- class start
renderer = class  a_week_of_false_starts extends stjohnsjimtemplate
  # 
  # section html
  # 
  # 
  ...
  # 
  post_a_week_of_false_starts: =>
    T.div "#post-a-week-of-false-starts.article.article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", =>
        T.div ".article-header", =>
          T.h1 ".article-title", itemprop: "name", => T.raw "A Week of False Starts"
          @bloviation()
  ...
  bloviation: =>
    T.div "#bloviation.article-entry.contents", "dangerously-set-inner-h-t-m-l": "[object Object]", =>
      ...
      T.p =>
        ...
        T.blockquote ".right.key-comment.soto.right-align.h6.p2.bg-white.border.rounded", => T.raw "soto says: Lets start a community library of tools from old construction projects. People can check out drills, saws and stuff!"
      T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", =>
      ...
      T.p =>
        ...
        T.blockquote ".right.key-comment.voce.right-align.h6.p2.bg-white.border.rounded", => T.raw "voce says: Did he just call her ‘Wickie’?!"
