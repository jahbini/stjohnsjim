...
"""
  ...
  # 
  post_tommy_gets_his_deal: =>
    T.div "#post-tommy-gets-his-deal.article.article-type-post", id: "post-tommy-gets-his-deal", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "Tommy gets his deal"
          @bloviation()
