...
"""
  ...
  # 
  post_the_finish_line: =>
    T.div "#post-the-finish-line.article.article-type-post", id: "post-the-finish-line", class: "article article-type-post", itemscope: "itemscope", itemprop: "blogPost", =>
      T.div ".article-inner.pb2", class: "article-inner pb2", =>
        T.div ".article-header", class: "article-header", =>
          T.h1 ".article-title", class: "article-title", itemprop: "name", => T.raw "The Finish Line."
          @bloviation()
        T.div ".article-footer.hide", class: "article-footer hide", =>
          T.a ".article-share-link", class: "article-share-link", "data-url": "http://localhost:3030/stjohnsjim/pnw-winter/undefined", "data-id": "cik30i1ai005w88ohxnylw27q", => T.raw "Share"
