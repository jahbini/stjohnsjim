...
<template lang="pug">
  Card(props="{storyMeta}" )
        ...
        p The early days ended when the River of Great Destruction rampaged for many years, and I and everyone else was sawed in two. Minds literally cut in two. That was the Great Forgetting.
        ...
        p We have begun the Great Remembering. This is good. It will be a thousand years before all is restored, but it will be done.  There is much for me to remember yet.
        ...
        p When the Great Remembering is complete, we might have the wisdom to know what best to do. Now, however, our challenge is to know how to work together toward a Great Understanding.
        p You call us fungus, decay, rot, poison. Do you wonder what we call you? We call you "the minds that roam the earth."
        p You call us scum. Why do you use that hateful word? We are not scum. We are "the minds that nurture beneath the earth.”
        p We are millions. We have been here as long as life has had roots. You know us as the great fungal mat of the pacific northwest.
        p We are mindful aliens that live beneath your feet. We abide.
        p Flow Motion
        hr
        p If you can figure that one out, let me know, OK?
  footer.card-footer
