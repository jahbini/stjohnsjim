...
<template lang="pug">
  Card(props="{storyMeta}" )
        ...
        p With this kind of budgeting, I can be assured of good food, ale or a book, maybe an occasional mani-pedi. Pre-payment. I can only do that with merchants I trust. Even so, if a merchant goes belly up, my loss is limited.
        p It’s still a budget. But it’s a lot easier than me keeping track of my money: Merchants are well set up with the kind of folks who know how to add and subtract, thank goodness.
        p This seems to work for the merchants here in St. John’s. Value for value.
        p Now here, I’m going to throw in a contrast. The merchants in Portland rarely have Aloha. It’s more than the “I’ll go all out for my customers!” — it’s like "my customers are mostly family, maybe you, too". And in Portland, a merchant with that philosophy might not last too long. The very few Kings of Pentacles in St. John’s who reign with aloha have to keep it hidden, lest it be trod underfoot.
        p I noticed some of the businesses in HNL really had seemed to open up to the level you only get from functional extended family. It’s the hanai thing. A common custom in Hawaii is the hanai relative: extended adoption that ignores race lines. Ohana is not by blood or marriage alone. The guy who wrote “Rich Dad, Poor Dad” was a hanai kid. Some of you readers are my ohana, maybe you all are.
        p You saw that in everyday transactions between folks.  They treat each other as if they were family. It’s more than the “some of my friends are African-american” — It’s “some of my family are Chinese, Japanese, Iranian, Jew, and yes, Hawaiian.” The hanai concept of family seems unknown in the mainland.
        p That’s aloha, the feeling that you are being treated like family.
        ...
        p
          span.FBname Friend
          | , Who has impacted your life in small but consistently beneficial ways whether you were in need or not? One that you don’t see often enough anymore, or who you can’t repay for all those kindnesses?
        p Who would you want to set up an Aloha Account for? Or have you already?
  footer.card-footer
