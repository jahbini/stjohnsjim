  ...
  .card-body
    .m1.bg-darken-1
      #bloviation.article-entry.contents(dangerously-set-inner-h-t-m-l='[object Object]')
        p Attention Deficit Disorder is a great source of humor:
        p How many ADD kids does it take to change a light bulb? Hey, I know, let’s go ride our bikes!
        p My grandfather managed his aging years with the observation: "I’ve hit so many rocks in my path, my plow is blunted"
        ...
        p But now our plows are blunted by catastrophe overload. We fear the dire consequeses and ignore them at the same time. It’s our National Attention Deficit Disorder. How many Citizens does it take to hold our leaders, both corporate and governmental, accountable for their absurd behavior? Hey, I know, let’s go watch a movie!
        p We see evidence of a constant barrage of mind grenades: in advertisements where the round walk-in bank vault morphs into the ample breast of a red, white and blue clad cheerleader — Obviously this bank won the World Cup of Mom-trust. At least at the P.R. level. Or what about the blue cloud bouncing sheep advertising a “medicine” where the voice-over announces dire and deadly side effects. We are lulled to sheep and act as sheep: we buy the product, eat the burger and put the house on the charge-card. All with the faith that we will win in the end. Our leaders tell us so.
        p In the face of these obvious psychological ploys to generate total credibility overload, we are asked to simply have faith. Isn’t that the hallmark of a religion? To take facts and logic as enemies of “faith?”
        p
          | So what’s a Portlander to do? To create or dismiss Counterspiricies of moles in the
          a(href='http://www.google.com/search?rls=en&q=bilderberg&ie=UTF-8&oe=UTF-8') Bilderberg Group
          | who are secretly controlled by the
          a(href='http://www.google.com/search?rls=en&q=john+birch+society&ie=UTF-8&oe=UTF-8') John Birch Society
          | ? Run and hide? Dig fallout shelters with our blunted plows?
        ...
        p
          ...
          a(href='http://audubonportland.org/local-birding/swiftwatch') Grade School Chimne
          | y. Tree-huggers that we are, we likely will have human-tree marriages sooner than California.
        ...
        p That’s St. John’s, Portland, Oregon on this glorious Summer of April 2, 2011 — It’s a Jaywalkers Paradise!
        p Jim’s Note - This one took several days, I want to thank S. McDonald for her suggestion of the "million dollar marble," which sparked the proper St. John’s ending, and PapaDon for his support and encouragement.
  footer.card-footer
