...
<template lang="pug">
  Card(props="{storyMeta}" )
        ...
        p Using my cell phone to light the way, I swam into the mouth of what looked like a very large drain pipe. Once inside, I climbed up a rotting ladder to a small room. The wall read 'Left to Shanghai,' and 'Right to St. John\’s.' Total proof.
