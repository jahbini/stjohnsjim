  ...
  .card-body
    .m1.bg-darken-1
      #bloviation.article-entry.contents(dangerously-set-inner-h-t-m-l='[object Object]')
        ...
        p I asked him if it hurt to have the blood in his head.
        p Yea, so what. It what I do. My system is better at handling it than others, and so, it gives me the most fun, with the least pain. For me.
        p So, Jake, you endure this painful, solitary thing, and you do this from choice, and because of the rush of joy it seems to give you? And you are happy with that choice?
        ...
        p If you don’t find love in the results, then you have not learned this important lesson, have you?
